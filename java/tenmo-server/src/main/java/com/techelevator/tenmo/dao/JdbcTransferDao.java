...
public class JdbcTransferDao implements TransferDao{
    ...
    public List<Transfer> listTransfers(int userId){
        ...
        while(results.next()) {
            ...
            transfer.setTransferType(transferType(results.getInt("transfer_type_id")));
            transfer.setTransferStatusID(results.getInt("transfer_status_id"));
            transfer.setTransferStatus(transferStatus(results.getInt("transfer_status_id")));
            transfer.setAccountFrom(results.getInt("account_from"));
            transfer.setAccountFromUsername(userDao.getUser(results.getInt("account_from")));
            transfer.setAccountTo(results.getInt("account_to"));
            transfer.setAccountToUsername(userDao.getUser(results.getInt("account_to")));
    ...
    public String transferStatus(int id){
        String status = "";
        if (id == 1) {
            status = "Pending";
        } else if (id == 2) {
